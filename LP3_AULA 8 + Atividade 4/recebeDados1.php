...
echo "<h2>Sistema de Aprovação Escolar - Resultado</h2>";
        if($freq < 75){
echo "<div class='alert alert-info' role='alert'>Reprovado por Faltas</div>";
}
        elseif($freq >= 75 && $media > 7){
echo "<div class='alert alert-success' role='alert'>Aprovado!</div>";
}
        elseif($freq >= 75 && $media > 4 && $media < 6.9){
echo "<div class='alert alert-warning' role='alert'>Recuperação</div>";
}
      elseif($freq >= 75 && $media < 4){
echo "<div class='alert alert-danger' role='alert'>Reprovado por Nota</div>";
}
?>
